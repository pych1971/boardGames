...
class BoardGameFromInternet:
    ...
    def game_from_Tesera_and_BGG(self):
        return (self.game_JSON_Tesera["game"]["title"],
                ...
                self.tree_XML_BGG.find('.//item/name').get('value'),
                float(self.tree_XML_BGG.find('.//*ratings/average').get('value')),
                float(self.tree_XML_BGG.find('.//*ratings/bayesaverage').get('value')),
                int(self.tree_XML_BGG.find(".//*ratings/ranks/*[@type='subtype']").get('value')),
                float(self.tree_XML_BGG.find('.//*ratings/averageweight').get('value')))
